...
import com.example.mappingfeb.respository.BusRepository;
import com.example.mappingfeb.respository.BusStopRepository;
import com.example.mappingfeb.respository.StopRepository;
...
public class BusStopController {
    ...
    @PostMapping
    public ResponseEntity<BusStop> allocateBusRoute(@RequestParam long busId, @RequestParam long stopId, @RequestBody BusStop busStop){
